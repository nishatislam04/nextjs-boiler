...
export default function Search({
  ...
  const [selectedOption, setSelectedOption] = useState(defaultSelectedData);
  ...
  const handleSubmit = (event) => {
    ...
    params.set("queryFor", searchQuery);
  ...
  return (
    <form className="flex w-[35rem] justify-start" onSubmit={handleSubmit}>
