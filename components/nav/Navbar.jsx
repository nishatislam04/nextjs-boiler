...
export default function Navbar() {
  ...
  return (
    <nav className="h-[var(--nav-height)] w-full border-gray-200 bg-white dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between py-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="mt-4 flex flex-col items-center rounded-lg border border-gray-100 bg-gray-50 p-2 font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:p-0 rtl:space-x-reverse dark:border-gray-700 dark:bg-gray-800 md:dark:bg-gray-900">
            ...
            <li>
              <NavLink
                ...
                label="Posts"
                className={`${
                  pathname === "/post" ? activeLinkStyle : inactiveLinkStyle
                } ${generalLinkStyle}`}
              />
            </li>
