		...
		<nav className="w-full bg-white border-gray-200 dark:bg-gray-900 h-[var(--nav-height)]">
			<div className="flex flex-wrap items-center justify-between py-4">
				...
				<div
					...
					id="navbar-default">
					<ul className="flex flex-col items-center p-2 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
